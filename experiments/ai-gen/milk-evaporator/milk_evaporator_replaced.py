...
def specify_model(model: pyo.ConcreteModel) -> None:
    ...
    specs.fix(fs.direct_steam_injection.inlet.flow_mol, 4.0)
    specs.fix(fs.direct_steam_injection.inlet.temperature, 353.15)
    specs.fix(fs.direct_steam_injection.inlet.pressure, 100.0e3)
    ...
    specs.fix(fs.direct_steam_injection.inlet.mole_frac_comp)
    specs.fix(fs.direct_steam_injection.steam_inlet.flow_mol, 0.853)
    specs.fix(fs.direct_steam_injection.steam_inlet.pressure, 200.0e3)
    specs.fix(
        fs.direct_steam_injection.steam_inlet.enth_mol,
        pyo.value(water.htpx(T=393.41 * pyo.units.K, p=200.0e3 * pyo.units.Pa)),
    )
    specs.fix(fs.E1Valve.deltaP, -40.0e3)
    specs.fix(fs.E2Valve.deltaP, -20.0e3)
    specs.fix(fs.E3Valve.deltaP, -10.0e3)

    specs.fix(fs.E1PS.split_fraction[TIME, "outlet_1", "Liq"], 0.99)
    specs.fix(fs.E1PS.split_fraction[TIME, "outlet_1", "Vap"], 0.01)
    specs.fix(fs.E2PS.split_fraction[TIME, "outlet_1", "Liq"], 0.99)
    specs.fix(fs.E2PS.split_fraction[TIME, "outlet_1", "Vap"], 0.01)
    specs.fix(fs.PhaseSeparator3.split_fraction[TIME, "outlet_1", "Liq"], 0.99)
    specs.fix(fs.PhaseSeparator3.split_fraction[TIME, "outlet_1", "Vap"], 0.01)

    specs.fix(fs.E1HX.overall_heat_transfer_coefficient, 1000.0)
    specs.fix(fs.E1HX.area, 10.0)
    specs.fix(fs.E1HX.shell.deltaP, 0.0)
    specs.fix(fs.E1HX.tube.deltaP, 0.0)
    specs.fix(fs.E2HX.overall_heat_transfer_coefficient, 1000.0)
    specs.fix(fs.E2HX.area, 1.0)
    specs.fix(fs.E2HX.shell.deltaP, 0.0)
    specs.fix(fs.E2HX.tube.deltaP, 0.0)
    specs.fix(fs.HeatExchanger3.overall_heat_transfer_coefficient, 70.0)
    specs.fix(fs.HeatExchanger3.area, 1.0)
    specs.fix(fs.HeatExchanger3.shell.deltaP, 0.0)
    specs.fix(fs.HeatExchanger3.tube.deltaP, 0.0)

    specs.fix(fs.Compressor1.efficiency_isentropic, 0.90)
    specs.replace(fs.Compressor1.work_mechanical, fs.Compressor1.outlet.pressure)
    specs.fix(fs.Compressor1.outlet.pressure, 80.0e3)
    specs.fix(fs.E2MVR.efficiency_isentropic, 0.90)
    specs.replace(fs.E2MVR.work_mechanical, fs.E2MVR.outlet.pressure)
    specs.fix(fs.E2MVR.outlet.pressure, 56.0e3)
    specs.fix(fs.Compressor3.efficiency_isentropic, 0.90)
    specs.replace(fs.Compressor3.work_mechanical, fs.Compressor3.outlet.pressure)
    specs.fix(fs.Compressor3.outlet.pressure, 72.0e3)
