...
def specify_model(model: pyo.ConcreteModel) -> None:
    ...
    fs.direct_steam_injection.inlet.temperature.fix(353.15)
    ...
    for exchanger, coefficient, area in (
        ...
        exchanger.overall_heat_transfer_coefficient.fix(coefficient)
        exchanger.area.fix(area)
        exchanger.hot_side.deltaP.fix(0.0)
        exchanger.cold_side.deltaP.fix(0.0)
    ...
    for compressor in (fs.Compressor1, fs.E2MVR, fs.Compressor3):
        compressor.efficiency_isentropic.fix(0.90)
