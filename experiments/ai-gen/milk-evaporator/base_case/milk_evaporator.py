...
def specify_model(model: pyo.ConcreteModel) -> None:
    ...
    fs.direct_steam_injection.inlet.flow_mol.fix(4.0)
    fs.direct_steam_injection.inlet.temperature.fix(80.0 + 273.15)
    fs.direct_steam_injection.inlet.pressure.fix(100.0e3)
    ...
    fs.E1Valve.deltaP.fix(-40.0e3)
    fs.E2Valve.deltaP.fix(-20.0e3)
    fs.E3Valve.deltaP.fix(-10.0e3)

    fs.E1HX.overall_heat_transfer_coefficient[TIME].fix(1000.0)
    fs.E1HX.area.fix(10.0)
    fs.E1HX.hot_side.deltaP[TIME].fix(0.0)
    fs.E1HX.cold_side.deltaP[TIME].fix(0.0)
    fs.E2HX.overall_heat_transfer_coefficient[TIME].fix(1000.0)
    fs.E2HX.area.fix(1.0)
    fs.E2HX.hot_side.deltaP[TIME].fix(0.0)
    fs.E2HX.cold_side.deltaP[TIME].fix(0.0)
    fs.HeatExchanger3.overall_heat_transfer_coefficient[TIME].fix(70.0)
    fs.HeatExchanger3.area.fix(1.0)
    fs.HeatExchanger3.hot_side.deltaP[TIME].fix(0.0)
    fs.HeatExchanger3.cold_side.deltaP[TIME].fix(0.0)

    for separator in (fs.E1PS, fs.E2PS, fs.PhaseSeparator3):
        separator.split_fraction[TIME, "outlet_1", "Liq"].fix(0.99)
        separator.split_fraction[TIME, "outlet_1", "Vap"].fix(0.01)

    fs.Compressor1.efficiency_isentropic[TIME].fix(0.90)
    fs.Compressor1.outlet.pressure.fix(80.0e3)
    fs.E2MVR.efficiency_isentropic[TIME].fix(0.90)
    fs.E2MVR.outlet.pressure.fix(56.0e3)
    fs.Compressor3.efficiency_isentropic[TIME].fix(0.90)
