...
\Title{Simplified Management of Equation-Oriented Process Models via a Systematic Variable Replacement Methodology}

% Author Orchid ID: enter ID or remove command
\newcommand{\orcidauthorA}{0009-0004-2774-463X} % Add \orcidA{} behind the author's name
%\newcommand{\orcidauthorB}{0000-0000-0000-000X} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Bert Downs $^{1}$\orcidA{}, Tim Walmsley*, Jason Kurz}
...
\abstract{Process models and process digital twins frequently rely on equation-oriented models (EOMs) to represent complex industrial systems. However, as EOMs increase in scale and complexity, managing model specifications, initialization, and degrees of freedom becomes increasingly difficult. This paper proposes a structured specification-management methodology for equation-oriented process modelling based on systematic variable replacement. Each unit operation defines a canonical set of specification variables that fully determine the model by default, representing design or operating decisions. Alternative specifications are introduced by explicitly replacing these variables with dependent variables, maintaining a square model while preserving semantic information about why variables are fixed. The methodology is implemented in the Pyomo and IDAES ecosystem through the pyomo-replace library. Case studies involving steady-state and dynamic process models demonstrate how the approach simplifies model construction, initialization, and transitions between design, operation, and performance-rating studies. The methodology also enables more interpretable graphical modelling workflows, demonstrated through integration into the Ahuora Digital Twin Platform. Results suggest that explicitly managing specification relationships can improve the maintainability and usability of large equation-oriented process models, particularly in interactive and modular modelling environments.}
