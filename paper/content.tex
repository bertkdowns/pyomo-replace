...
is reduced because the Initial Variables fully define the baseline
...
defined for the Initial Variables. To convert a model from a design to
...
This method of replacing Initial Variables does not fundamentally change
...
Using a Variable Replacement approach, a set of Initial Variables would
...
requires a variable to be fixed that is not an Initial Variable, an
appropriate\footnote{i.e an Initial Variable that would be part of the
  Dulmage-Mendelson over-constrained set if the other variable was
  fixed and nothing was unfixed} Initial Variable must be unfixed too.
